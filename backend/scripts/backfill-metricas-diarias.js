...
// Path explicito: dotenv por defecto resuelve .env desde process.cwd(), no desde
// __dirname. Este script se invoca desde la raiz del repo (y desde tareas
// programadas), donde no hay .env — sin el path solo funciona si el operador ya
// exporto DATABASE_URL en esa misma sesion. Mismo patron que src/index.js y
// prisma/seed-catalogo.js.
