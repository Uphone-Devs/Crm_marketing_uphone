...
async function main() {
  const password = '***CREDENTIAL_REMOVED***';
  ...
  console.log('Admin:      admin@sistema.local      / ***CREDENTIAL_REMOVED***');
  console.log('Supervisor: supervisor@sistema.local  / ***CREDENTIAL_REMOVED***');
  console.log('Gestor:     gestor@sistema.local      / ***CREDENTIAL_REMOVED***');
  console.log('─'.repeat(50));
}
